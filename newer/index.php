...
<div class="container text-center fw-light fs-2 p-2 my-2 container rounded w-75 svg-section-background m-auto"
    ...
    <div class="container p-1">
        <div class="text-center fs-4" style="font-family: 'Play', sans-serif">
            <button class="btn fs-3 py-0 svg-header-background btn-svg-bg">🔀 Shuffle</button>

            <input type="checkbox" class="btn-check" id="btn-check" autocomplete="off">
            <label class="btn fs-3 py-0 svg-header-background btn-svg-bg-2" for="btn-check">Category 1</label>

            <input type="checkbox" class="btn-check" id="btn-check-2" autocomplete="off">
            <label class="btn fs-3 py-0 svg-header-background btn-svg-bg-1" for="btn-check-2">Category 2</label>

            <input type="checkbox" class="btn-check" id="btn-check-3" autocomplete="off">
            <label class="btn fs-3 py-0 svg-header-background btn-svg-bg-2" for="btn-check-3">Category 3</label>

            <input type="checkbox" class="btn-check" id="btn-check-4" autocomplete="off">
            <label class="btn fs-3 py-0 svg-header-background btn-svg-bg-1" for="btn-check-4">Category 4</label>
        </div>
    </div>
