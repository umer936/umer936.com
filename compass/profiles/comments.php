...
include '../db.php';
$commid=$_GET['user'];
echo "<form name=input action='postcomm.php?id=$commid' method=post onsubmit=\"document.getElementById('Submit').value='Posting!'; document.getElementById('Submit').disabled=true;\">
