...
<head>
    ...
    <script type="text/javascript">
        window.cookieconsent_options = {
            "message": "Take a look at my new résumé:",
            "dismiss": "Nah, I'm good",
            "learnMore": "Take me there!",
            "link": "https://github.com/umer936/My-CV/raw/master/output_pdfs/2020_Resume.pdf",
            "theme": "dark-bottom"
        };
    </script>
    ...
    <link rel="icon" sizes="192x192" href="/images/logoh.png">
</head>
<div id="meatwrap">
    <div id="meat">CODER. PROGRAMMER. DESIGNER.</div>
</div>
<div id="socialwrap">
    <div id="social">
